...
const GalleryPage = () => {
  ...
  const allImages = [
    ...
    { 
      ...
      title: 'Customer Design 14',
      description: 'Real beauty in every stitch',
      image: '/gallery/real_pics/21.webp',
      isPortrait: false
    },
    { 
      id: 28, 
      ...
      title: 'Customer Design 14',
      description: 'Real beauty in every stitch',
      image: '/gallery/real_pics/22.webp',
      isPortrait: false
    },
    { 
      id: 29, 
      ...
      title: 'Customer Design 14',
      description: 'Real beauty in every stitch',
      image: '/gallery/real_pics/23.webp',
      isPortrait: false
    },
    { 
      id: 30, 
      ...
      title: 'Customer Design 14',
      description: 'Real beauty in every stitch',
      image: '/gallery/real_pics/24.webp',
      isPortrait: false
    },
    { 
      id: 31, 
      ...
      title: 'Customer Design 14',
      description: 'Real beauty in every stitch',
      image: '/gallery/real_pics/25.webp',
      isPortrait: false
    },
    { 
      id: 32, 
      ...
      title: 'Customer Design 14',
      description: 'Real beauty in every stitch',
      image: '/gallery/real_pics/26.webp',
      isPortrait: false
    },
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                size="lg"
                onClick={() => {
                  const whatsappUrl = `https://wa.me/+919030145694?text=${encodeURIComponent('Hi! I saw your gallery and I\'m interested in your tailoring services. Can you please provide more details?')}`;
