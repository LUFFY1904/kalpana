          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <motion.span 
                ...
                animate={{ color: ["hsl(283, 73%, 68%)", "hsl(172, 51%, 68%)", "hsl(313, 59%, 58%)"] }}
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <RealButton variant="elegant" size="lg" className="w-full sm:w-auto" asChild>
                  <a href="https://www.google.com/maps/place/Kalpana+buttons+shop/@16.7815035,79.3195979,1132m/data=!3m2!1e3!4b1!4m6!3m5!1s0x3bcacdc8741ebf13:0xc85a910b309713da!8m2!3d16.7815035!4d79.3195979!16s%2Fg%2F11tt5dmlvf?entry=ttu&g_ep=EgoyMDI2MDMxMS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer">
                    Get directions
                  </a>
                </RealButton>
              </motion.div>
