            ...
            <Card className="p-6 shadow-card bg-card border-none">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    <a href="tel:+919030145694" className="hover:text-primary transition-colors">+91 9030145694</a>
                  </p>
                </div>
              </div>
            </Card>
            <Card className="p-6 shadow-card bg-card border-none">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    <a href="mailto:bingikalpana123@gmail.com" className="hover:text-primary transition-colors">bingikalpana123@gmail.com</a>
                  </p>
                </div>
              </div>
            </Card>
