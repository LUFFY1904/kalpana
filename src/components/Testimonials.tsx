      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Don't just take our word for it. Here's what our valued clients across Nalgonda Dist 
        ...
        <div className="text-center mt-16 animate-fade-in">
          ...
          <button
            onClick={() => {
              const whatsappUrl = `https://wa.me/+919030145694?text=${encodeURIComponent('Hi! I would like to book an appointment for tailoring services.')}`;
